...
module.exports = class ManualDonations {
  constructor(kentaaApi)
  {
    this.kentaaApi = kentaaApi;
    this.apiLocation = "manual-donations";
    this.returnedListName = "manual_donations";
  }

  /** Returns entire list of Manual Donations on the ENTIRE SITE. See https://developer.kentaa.nl/kentaa-api/?shell#list-manual-donations
